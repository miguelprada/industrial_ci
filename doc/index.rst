...
* **TARGET_WORKSPACE** (default: not set): Definition of extra sources for target workspace.
...
* URL of a source repository with the pattern ``<scheme>:<ressource>#<version>``, e.g. ``github:ros-industrial/industrial_ci#master``.
